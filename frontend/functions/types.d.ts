/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path=./functions/types.d.ts` (hash: 13d38c2094ffc1b3c5b5509274494cb8)
// Runtime types generated with workerd@1.20250508.0 2025-05-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		API_BASE_URL: "http://localhost:5080" | "https://api.ratemy.pet";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_BASE_URL" | "NODE_VERSION">> {}
}
